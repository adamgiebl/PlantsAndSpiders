...
const resizeCanvas = () => {
  ...
  mask.width = innerWidth;
  mask.height = innerHeight;
  exports.groundY = groundY = canvas.height - groundHeight;
};
...
var _GlassShatter = _interopRequireDefault(require("/static/sounds/GlassShatter.mp3"));
...
class AudioPlayer {
  ...
  async loadAllSounds() {
    await Promise.all([audioPlayer.loadAudio(_ShotgunQuieter.default), audioPlayer.loadAudio(_Splash.default), audioPlayer.loadAudio(_GlassShatter.default), audioPlayer.loadAudio(_reggae.default)]).then(([gunshot, splash, glass, music]) => {
...
},{"/src/shared/canvas":"src/shared/canvas.js","/src/shared/UI":"src/shared/UI.js","/src/classes/loaders":"src/classes/loaders.js"}],"src/classes/light.js":[function(require,module,exports) {
"use strict";
