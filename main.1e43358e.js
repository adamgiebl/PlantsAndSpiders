...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"static/manifests/gameConfig.json":[function(require,module,exports) {
module.exports = {
...
titleScreen.addEventListener('click', () => {
  ...
  tutorialScreen.addEventListener('click', () => {
    ...
    GameLoop(_gameConfig.default).then(startGame => {
...
*/
},{"/static/manifests/gameConfig.json":"static/manifests/gameConfig.json","./styles/style.scss":"src/styles/style.scss"}],"../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
