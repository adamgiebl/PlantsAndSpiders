...
self.addEventListener('install', function (event) {
    ...
    event.waitUntil(
      caches.open(staticAssetsCacheName).then(function (cache) {
        cache.addAll([
            '/',
            "14eaac23ec191904c72b6844b3082658.mp3","33df3f0790cee72bb6d12c5d2a1240b9.mp3","930b82081238d08754da34145e2e3e11.mp3","aa23f122d6523a5a8e8979ea2446eae1.mp3","images/Background2.png","images/Background3-compressor.png","images/Background3.png","images/CharacterLower.svg","images/CharacterLowerFlipped.svg","images/CharacterLowerSpriteSheet.svg","images/CharacterLowerSpriteSheetOld.svg","images/CharacterUpper.png","images/CharacterUpper.svg","images/CharacterUpperFlipped.svg","images/Flash.svg","images/Lamp.svg","images/logo.svg","images/Pot.svg","images/scene.png","images/score.svg","images/Seed.png","images/Seed.svg","images/SpiderSplash.svg","images/SpiderSpriteSheet.svg","images/SVG/Asset 1.svg","images/SVG/leaf.svg","images/title-background.png","index.html","main.205d8b49c68844f08a95.js","manifests/character.json","manifests/gameConfig.json","manifests/light.json","manifests/plant.json","manifests/scene.json","manifests/spider.json","plants/Plant1.png","plants/Plant1.svg","plants/Plant2.png","plants/Plant2.svg","plants/Plant3.png","plants/Plant3.svg","plants/Plant4.png","plants/Plant4.svg","sounds/GlassShatter.mp3","sounds/hush.mp3","sounds/reggae.mp3","sounds/Shotgun.mp3","sounds/ShotgunQuieter.mp3","sounds/Splash.mp3"
        ]
        );
      }).catch((error) => {
